...
class ApiEndpoints {
  ...
  static const String vendorProfile = '/api/v1/vendor/profile/';
  static const String vendorBusinessProfile = '/api/v1/vendor/business-profile/';
  static const String vendorKycUpload = '/api/v1/vendor/kyc-upload/';
